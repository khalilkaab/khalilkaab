...
<html class="wide wow-animation" lang="en">
  <head>
    ...
    <!-- Stylesheets-->
    <link rel="stylesheet" type="text/css" href="../css?family=Changa+One:400,400i%7CGrand+Hotel%7CLato:300,400,400italic,700">
      ...
      <main class="page-content">
          ...
          <div class="swiper-variant-1">
            <div class="swiper-container swiper-slider" data-slide-effect="fade" data-min-height="600px">
              <div class="swiper-wrapper">
                      ...
                      <div class="row align-items-sm-center">
                        ...
                        <div class="col-sm-6 col-md-7 col-lg-8 text-lg-end veil reveal-sm-inline-block">
                          <div style="position:relative;z-index:2;">
                            <div data-caption-animate="fadeInLeftSm" data-caption-delay="1500"><img class="img-caption-5 img-responsive veil reveal-lg-inline-block" src="images/slide-caption-image-6-100x118.png" alt="" width="100" height="118">
                            </div>
                            <div data-caption-animate="fadeInRotate" data-caption-delay="100"><img class="img-responsive reveal-inline-block" src="images/slide-caption-image-1-599x596.png" alt="" width="599" height="596">
                            </div>
                          </div>
                          <div class="img-caption-1" data-caption-animate="fadeInRightSm" data-caption-delay="600"><img class="img-responsive veil reveal-lg-inline-block" src="images/slide-caption-image-2-346x336.png" alt="" width="346" height="336">
                          </div>
                          <div class="img-caption-2" data-caption-animate="fadeInRightSm" data-caption-delay="900"><img class=" img-responsive veil reveal-lg-inline-block" src="images/slide-caption-image-3-228x310.png" alt="" width="228" height="310">
                          </div>
                          <div class="img-caption-3" data-caption-animate="fadeInLeftSm" data-caption-delay="800"><img class=" img-responsive veil reveal-lg-inline-block" src="images/slide-caption-image-4-179x213.png" alt="" width="179" height="213">
                          </div>
                          <div class="img-caption-4" data-caption-animate="fadeInLeftSm" data-caption-delay="1000"><img class="img-responsive veil reveal-lg-inline-block" src="images/slide-caption-image-5-522x343.png" alt="" width="522" height="343">
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="swiper-slide" data-slide-bg="images/home-slide-2-1920x800.jpg">
                  <div class="swiper-slide-caption text-center">
                    <div class="container">
                      <div class="row align-items-sm-center">
                        <div class="col-sm-6 col-md-5 col-lg-4 text-uppercase">
                        ...
                        <div class="col-sm-6 col-md-7 col-lg-8 text-lg-end veil reveal-sm-inline-block">
                          <div style="position:relative;z-index:2;">
                            ...
                            <div data-caption-animate="fadeInRotate" data-caption-delay="100"><img class="img-responsive reveal-inline-block" src="images/slide-caption-image-2-599x596.png" alt="" width="599" height="596">
                            </div>
                          </div>
                          <div class="img-caption-1" data-caption-animate="fadeInRightSm" data-caption-delay="600"><img class="img-responsive veil reveal-lg-inline-block" src="images/slide-caption-image-22-346x336.png" alt="" width="346" height="336">
                          </div>
                          <div class="img-caption-2" data-caption-animate="fadeInRightSm" data-caption-delay="900"><img class=" img-responsive veil reveal-lg-inline-block" src="images/slide-caption-image-32-228x310.png" alt="" width="228" height="310">
                          </div>
                          <div class="img-caption-3" data-caption-animate="fadeInLeftSm" data-caption-delay="800"><img class=" img-responsive veil reveal-lg-inline-block" src="images/slide-caption-image-4-179x213.png" alt="" width="179" height="213">
                          </div>
                          <div class="img-caption-4" data-caption-animate="fadeInLeftSm" data-caption-delay="1000"><img class="img-responsive veil reveal-lg-inline-block" src="images/slide-caption-image-5-522x343.png" alt="" width="522" height="343">
                      ...
                      <div class="row align-items-sm-center">
                        ...
                        <div class="col-sm-6 col-md-7 col-lg-8 text-lg-end veil reveal-sm-inline-block">
                          <div style="position:relative;z-index:2;">
                            ...
                            <div data-caption-animate="fadeInRotate" data-caption-delay="100"><img class="img-responsive reveal-inline-block" src="images/slide-caption-image-3-599x596.png" alt="" width="599" height="596">
                            </div>
                          </div>
                          <div class="img-caption-1" data-caption-animate="fadeInRightSm" data-caption-delay="600"><img class="img-responsive veil reveal-lg-inline-block" src="images/slide-caption-image-2-346x336.png" alt="" width="346" height="336">
                          </div>
            ...
            <div class="row justify-content-xs-center">
              <div class="col-xs-12">
                ...
                <div class="menu-classic bg-menu-7 menu-classic-single">
                  ...
                  <ul class="list-menu">
                    <li>
                      <div class="menu-item h6"><span><span>PITA AU VIANDE HACHÉE GRILLÉ</span></span><span>45DH</span></div>
                      <div class="menu-item-desc"><span>La pita est garnie de salades fraîches, de légumes, hummus, fromage feta et de sauces maison de votre choix</span></div>
                    </li>
                    <li>
                      <div class="menu-item h6"><span><span>PITA AU BŒUF GRILLÉ</span></span><span>45DH</span></div>
                      <div class="menu-item-desc"><span>La pita est garnie de salades fraîches, de légumes, hummus, fromage feta et de sauces maison de votre choix</span></div>
                    </li>
                    <li>
                      <div class="menu-item h6"><span><span>PITA AU POULET GRILLÉ</span></span><span>45DH</span></div>
                      <div class="menu-item-desc"><span>La pita est garnie de salades fraîches, de légumes, hummus, fromage feta et de sauces maison de votre choix</span></div>
                    </li>
                    <li>
                      <div class="menu-item h6"><span><span>PITA AU POULET PANÉ</span></span><span>45DH</span></div>
                      <div class="menu-item-desc"><span>La pita est garnie de salades fraîches, de légumes, hummus, fromage feta et de sauces maison de votre choix</span></div>
                    </li>
                    <li>
                      <div class="menu-item h6"><span><span>PITA AU MOUSSE THON</span></span><span>45DH</span></div>
                      <div class="menu-item-desc"><span>La pita est garnie de salades fraîches, de légumes, hummus, fromage feta et de sauces maison de votre choix</span></div>
                    </li>
                    <li>
                      <div class="menu-item h6"><span><span>PITA AU FALAFEL VEGAN</span></span><span>45DH</span></div>
                      <div class="menu-item-desc"><span>La pita est garnie de salades fraîches, de légumes, hummus, fromage feta et de sauces maison de votre choix</span></div>
                    </li>
                  </ul>
                                  </div>
                  ...
                  <div class="item">
                    <div class="thumbnail-menu-modern">
                      ...
                      <div class="caption">
                        ...
                        <p class="">42.50 DH</p><a class="btn btn-shape-circle btn-burnt-sienna offset-top-15" href="shop-single.html">Order Online</a>
                      </div>
                    </div>
                  </div>
                  <div class="item">
                    <div class="thumbnail-menu-modern">
                      <figure><img class="img-responsive" src="images/menu-modern-3-310x260.png" alt="" width="310" height="260">
                      </figure>
                      <div class="caption">
                        <h5><a class="link link-default" href="menu-single.html">Mini Burger</a></h5>
                        ...
                        <p class="">40.90 DH</p><a class="btn btn-shape-circle btn-burnt-sienna offset-top-15" href="shop-single.html">Order Online</a>
                      </div>
                    </div>
                  </div>
                  <div class="item">
                    <div class="thumbnail-menu-modern">
                      <figure><img class="img-responsive" src="images/menu-modern-2-310x260.png" alt="" width="310" height="260">
                      </figure>
                      <div class="caption">
                        <h5><a class="link link-default" href="menu-single.html">Classic Burger</a></h5>
                        ...
                        <p class="">43.90 DH</p><a class="btn btn-shape-circle btn-burnt-sienna offset-top-15" href="shop-single.html">Order Online</a>
                      </div>
                    </div>
                  </div>
                  <div class="item">
                    <div class="thumbnail-menu-modern">
                      <figure><img class="img-responsive" src="images/menu-modern-6-310x260.png" alt="" width="310" height="260">
                      </figure>
                      <div class="caption">
                        <h5><a class="link link-default" href="menu-single.html">California Burger</a></h5>
                        ...
                        <p class="">47.97 DH</p><a class="btn btn-shape-circle btn-burnt-sienna offset-top-15" href="shop-single.html">Order Online</a>
                      </div>
                    </div>
                  </div>
                  <div class="item">
                    <div class="thumbnail-menu-modern">
                      <figure><img class="img-responsive" src="images/menu-modern-5-310x260.png" alt="" width="310" height="260">
                      </figure>
                      <div class="caption">
                        <h5><a class="link link-default" href="menu-single.html">Double Burger</a></h5>
                        ...
                        <p class="">45.00 DH</p><a class="btn btn-shape-circle btn-burnt-sienna offset-top-15" href="shop-single.html">Order Online</a>
                      </div>
                    </div>
                  </div>
                  <div class="item">
                    <div class="thumbnail-menu-modern">
                      <figure><img class="img-responsive" src="images/menu-modern-4-310x260.png" alt="" width="310" height="260">
                      </figure>
                      <div class="caption">
                        <h5><a class="link link-default" href="menu-single.html">Chicken Burger</a></h5>
                        ...
                        <p class="">40.50 DH</p><a class="btn btn-shape-circle btn-burnt-sienna offset-top-15" href="shop-single.html">Order Online</a>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="slick-slider slick-tab-centered" data-arrows="true" data-loop="true" data-dots="false" data-swipe="true" data-items="1" data-xs-items="1" data-sm-items="2" data-md-items="3" data-lg-items="3" data-xl-items="5" data-center-mode="true" data-center-padding="10">
                  ...
                  <div class="item">
                    <div class="thumbnail-menu-modern">
                      ...
                      <div class="caption">
                        <h5><a class="link link-default" href="menu-single.html">Chicken Toast</a></h5>
                ...
                <div class="slick-slider slick-tab-centered" data-arrows="true" data-loop="true" data-dots="false" data-swipe="true" data-items="1" data-xs-items="1" data-sm-items="2" data-md-items="3" data-lg-items="3" data-xl-items="5" data-center-mode="true" data-center-padding="10">
                  ...
                  <div class="item">
                    <div class="thumbnail-menu-modern">
                      ...
                      <div class="caption">
                        <h5><a class="link link-default" href="menu-single.html">Pepperoni</a></h5>
                ...
                <div class="slick-slider slick-tab-centered" data-arrows="true" data-loop="true" data-dots="false" data-swipe="true" data-items="1" data-xs-items="1" data-sm-items="2" data-md-items="3" data-lg-items="3" data-xl-items="5" data-center-mode="true" data-center-padding="10">
                  ...
                  <div class="item">
                    <div class="thumbnail-menu-modern">
                      ...
                      <div class="caption">
                        <h5><a class="link link-default" href="menu-single.html">Chicken Caprese</a></h5>
                ...
                <div class="slick-slider slick-tab-centered" data-arrows="true" data-loop="true" data-dots="false" data-swipe="true" data-items="1" data-xs-items="1" data-sm-items="2" data-md-items="3" data-lg-items="3" data-xl-items="5" data-center-mode="true" data-center-padding="10">
                  ...
                  <div class="item">
                    <div class="thumbnail-menu-modern">
                      ...
                      <div class="caption">
                        <h5><a class="link link-default" href="menu-single.html">Classic Lemonade</a></h5>
                ...
                <div class="slick-slider slick-tab-centered" data-arrows="true" data-loop="true" data-dots="false" data-swipe="true" data-items="1" data-xs-items="1" data-sm-items="2" data-md-items="3" data-lg-items="3" data-xl-items="5" data-center-mode="true" data-center-padding="10">
                  ...
                  <div class="item">
                    <div class="thumbnail-menu-modern">
                      ...
                      <div class="caption">
                        <h5><a class="link link-default" href="menu-single.html">Chocolate Fudge Cake</a></h5>
        ...
        <section class="section-50 section-sm-100">
          <div class="container-wide">
            <div class="row justify-content-xs-center">
              <div class="col-sm-6 col-md-4 view-animate zoomInSmall delay-04"><a class="thumbnail-variant-3" href="menu-single.html"><img class="img-responsive" src="images/index-01-566x401.jpg" alt="" width="566" height="401">
                  <div class="caption text-center">
                    <h3 class="text-italic">For Vegans</h3>
                    <p class="big">Burger + French Fries + Drink</p>
                  </div></a></div>
              <div class="col-sm-6 col-md-4 view-animate zoomInSmall delay-06"><a class="thumbnail-variant-3" href="menu-single.html"><img class="img-responsive" src="images/index-02-566x401.jpg" alt="" width="566" height="401">
                  <div class="caption text-center">
                    <h3 class="text-italic">Order Online</h3>
                    <p class="big">Available Every Day 9 AM - 11 PM</p>
                  </div></a></div>
              <div class="col-sm-6 col-md-4 offset-sm-top-30 offset-md-top-0 view-animate zoomInSmall delay-02"><a class="thumbnail-variant-3" href="menu-single.html"><img class="img-responsive" src="images/index-03-566x401.jpg" alt="" width="566" height="401">
                  <div class="caption text-center">
        ...
        <section class="bg-image-5">
          <section class="parallax-container parallax-light" data-parallax-img="images/parallax-03.png">
              ...
              <div class="container section-80 section-sm-top-140 section-sm-bottom-150 text-center">
                <div class="row justify-content-xs-center">
                  <div class="col-sm-10 col-lg-6">
                    ...
                    <div class="label- o4fset DH-top-10">
                      <div class="unit unit-horizontal unit-middle unit-spacing-xs">
                        <div class="unit-left">
                          <h1 class="text-accent">3<sup class="h3 text-accent">99</sup></h1>
                        </div>
                        <div class="unit-body">
                    ...
                    </div><a class="btn btn-burnt-sienna btn-md btn-shape-circle offset-top-15" href="menu-classic.html">order online</a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section>
          <div class="row g-0" data-lightgallery="group">
            <div class="col-xs-6 col-md-3"><a class="thumbnail-gallery" data-lightgallery="item" href="images/index-gallery-1-1200x800_original.jpg"><img src="images/index-gallery-1-480x394.jpg" alt="" width="480" height="394"></a></div>
            <div class="col-xs-6 col-md-3"><a class="thumbnail-gallery" data-lightgallery="item" href="images/index-gallery-2-1200x800_original.jpg"><img src="images/index-gallery-2-480x394.jpg" alt="" width="480" height="394"></a></div>
            <div class="col-xs-6 col-md-3"><a class="thumbnail-gallery" data-lightgallery="item" href="images/index-gallery-3-1200x800_original.jpg"><img src="images/index-gallery-3-480x394.jpg" alt="" width="480" height="394"></a></div>
            <div class="col-xs-6 col-md-3"><a class="thumbnail-gallery" data-lightgallery="item" href="images/index-gallery-4-1200x800_original.jpg"><img src="images/index-gallery-4-480x394.jpg" alt="" width="480" height="394"></a></div>
          </div>
        </section>
        <section>
